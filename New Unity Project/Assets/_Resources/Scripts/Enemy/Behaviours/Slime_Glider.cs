...
public class Slime_Glider : MonoBehaviour
{
    Transform _t;
    ...
    public enum State { walk, attack, glide };
    ...
    float walkCounter, waitCounter, attackTimer = 1, wait = 1;
